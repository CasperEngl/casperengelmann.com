...
- <Experience
  ...
  <details>
    ...
    At the moment we're building a new cross-platform app based on Vue. On the frontend I upgraded our project to Vue 2.7 which unlocked the Composition API. 
